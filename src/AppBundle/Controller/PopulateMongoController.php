...
class PopulateMongoController extends Controller
{
    /**
     * @Route("/populate-mongo")
     *
    ...
    public function populateMongoAction(Request $request)
    {
        ...
        $campaignLink->setDestination('http://symfony-micro.dev/populate-mongo');
