...
class TrackClick
{
     ...
     *
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\TrackConversion", mappedBy="trackClick", cascade={"persist"})
     */
     ...
     * @var Publisher
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Publisher\Publisher", inversedBy="trackClicks")
     * @ORM\JoinColumns({
     ...
     * @var CampaignLink
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Campaign\CampaignLink", inversedBy="trackClicks")
     * @ORM\JoinColumns({
     ...
     * @var TrackImpression
     *
     * @ORM\ManyToOne(targetEntity="TrackImpression", inversedBy="trackClicks")
     * @ORM\JoinColumns({
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\TrackClickData", mappedBy="click")
     */
    protected $clickData;
     ...
     * Get trackImpression.
     *
     * @return \AppBundle\Entity\TrackImpression
     */
